...
def generate_music(inference_model, num_gen=1, basefname="defaultmymusic", corpus = corpus, abstract_grammars = abstract_grammars, tones = tones, tones_indices = tones_indices, indices_tones = indices_tones, T_y = 10, max_tries = 1000, diversity = 0.5):
    """
    ...
    for i in range(num_gen):
        ...
        # TODO:set name
        filename = "output/"+basefname+i+".midi"
        mf.open(filename, 'wb')
        mf.write()
        mf.close()
    ...
    print("Your generated music is saved in output dir")
    return out_streams
