...
if __name__=='__main__':
    # chord_data, raw_music_data = get_musical_data('/media/naykun/C836A2D236A2C134/TsinghuaResearch/lmd_full/0/0a0fd09e0e52a87c7ab672dd31393109.mid')
    chord_data, raw_music_data = get_musical_data('/media/naykun/C836A2D236A2C134/TsinghuaResearch/Jazz improvisation with LSTM/data/original_metheny.mid')
