...
from keras.layers import Dense, Activation, LSTM, Input, Embedding, MaxPooling1D, Conv1D, Dropout, Bidirectional
...
exp_name = 'Embedding_method_WordEmbedding_Infolen%d_LS%d_WinSize%d_BS%d_%dpart_epoch%d' % (infor_length, LayerSize, time_step, batch_size, how_much_part, epochs)
...
max_features = 1000
xxx = Embedding(max_features, 10)(inputs)
