...
exp_name = 'Embedding_method_Bi_LSTM_Infolen%d_LS%d_WinSize%d_BS%d_%dpart_epoch%d' % (infor_length, LayerSize, time_step, batch_size, how_much_part, epochs)
...
xxx = Bidirectional(LSTM(LayerSize, return_sequences=True, dropout=0))(inputs)
